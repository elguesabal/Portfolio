function Cabecalho() {
    ...
    return (
        <div class="main_box">
            ...
            {/* <div class="botao_one">         FOI PASSADO PARA O fundo.jsx
                <label for="check">
            ...
            <div class="sidebar_menu">
                ...
                <div class="menu">
                    <ul>
                        ...
                        <a href="https://github.com/elguesabal" target="_blank">
                            <li>
                        ...
                        <a href="https://www.linkedin.com/in/jos%C3%A9-antonio-b14160240/" target="_blank">
                            <li>
